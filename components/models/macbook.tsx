...
Files: macbook.glb [629.72KB] > C:\Importent Files\Personal projects\3js\apple-website\public\models\macbook-transformed.glb [627.9KB] (0%)
...
export default function MacBookModel(props: any) {
  const { texture, setTexture, color } = useGlobalStore();
